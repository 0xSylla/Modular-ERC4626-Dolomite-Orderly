...
// V3 factory mints DiracVaultV3 instances. The aliased import keeps the rest
// of this file structurally identical to V1/V2.
import {DiracVaultV3 as DiracVault} from "../vault/DiracVaultV3.sol";
import {IDiracVaultFactory} from "../interfaces/IDiracVaultFactory.sol";

/// @title DiracVaultFactoryV3
/// @notice V3 factory — identical to V2 except every newly-deployed vault is
///         a DiracVaultV3 instance (inner-revert bubbling + 3-state cycle).
///         Whitelisting, role grants, enumeration, fee config all unchanged.
///         Storage layout matches V1/V2 for tooling compatibility.
/// @dev Owned by the Dirac multisig. Gets OWNER_ROLE on every vault it deploys.
contract DiracVaultFactoryV3 is AccessControl, IDiracVaultFactory {
